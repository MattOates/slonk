...
class TestRealWorldScenarios:
    ...
    def test_log_processing_pipeline(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            # Pipeline: read log file -> filter ERROR lines -> count
            slonk = (Slonk()
                    | log_file
                    | "grep ERROR"
                    | "wc -l")
    ...
    def test_file_backup_pipeline(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            slonk = (Slonk()
                    | source_file
                    | copy_file
                    | f"diff {source_file} {backup_file}")
    ...
    def test_configuration_processing_pipeline(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            def extract_database_config(data):
